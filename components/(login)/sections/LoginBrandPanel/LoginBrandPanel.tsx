...
export default function LoginBrandPanel({
  ...
  return (
    <motion.aside
      className="relative hidden flex-1 flex-col justify-between overflow-hidden border-r-[3px] border-black bg-primary-container p-10 md:flex lg:p-14"
      initial="hidden"
      animate="show"
      ...
      <motion.div
        ...
        <motion.div
          aria-hidden="true"
          className="absolute left-8 top-8 h-24 w-24 border-[3px] border-black bg-primary-container shadow-[6px_6px_0_0_#181c20]"
          animate={{ rotate: [-6, 2, -6], y: [0, -6, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          aria-hidden="true"
          className="absolute bottom-10 left-16 h-16 w-16 border-[3px] border-black bg-secondary-container shadow-[4px_4px_0_0_#181c20]"
        ...
        <motion.div
          aria-hidden="true"
          className="absolute right-8 top-1/2 flex h-28 w-28 -translate-y-1/2 items-center justify-center border-[3px] border-black bg-black text-white shadow-[6px_6px_0_0_#63ad6f]"
          animate={{ rotate: [0, 6, 0], scale: [1, 1.05, 1] }}
          transition={{ duration: 5.5, repeat: Infinity, ease: "easeInOut" }}>
          <LucideIcon name="lock" className="text-5xl" />
        </motion.div>
